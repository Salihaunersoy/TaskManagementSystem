...
namespace TaskManagementSystem.Context
{
	public class TaskManagementDbContext : DbContext
	{
		...
		{
			optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=TaskManagementDb;Trusted_Connection=True;TrustServerCertificate=True");
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Task>(entity =>
			{
				...
				entity.Property(t => t.Status)     .IsRequired().HasMaxLength(10);
